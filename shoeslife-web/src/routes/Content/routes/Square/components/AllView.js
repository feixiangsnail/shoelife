...
class AllView extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Search items={this._getFormItems()} onSubmit={getFormOptions().handleSubmit} onReset={getFormOptions().handleReset} sign="all" />
        <DataTable bordered={false} columns={this._getColumns()}  {...tableOptions} ref="dt" sign="all"/>
