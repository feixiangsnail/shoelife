...
class Detail extends Component {
  ...
  render() {
    ...
    return (
      <div className={classes.infor} id="printOrder">
        <Row>
          <Col span="14">
            <dl>
              <dt>基本信息</dt>
        ...
        <Button type="ghost" onClick={context.toPrint.bind(context)}>打印此页</Button>
        &nbsp;&nbsp;&nbsp;
        <DownLoader url={ORDER_DETAIL_EXPORT + params.id} title='下载样板单'/>
      </div>
    )
  }
}
